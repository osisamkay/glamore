  ...
  return (
    <footer className="bg-purple-900 text-white">
      ...
      <div className="container mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        {/* Column 3 - My Account */}
        <div>
          <h3 className="text-sm font-semibold mb-4 uppercase">My Account</h3>
          <ul className="space-y-2 text-sm text-gray-300">
        ...
        <div>
          <h3 className="text-sm font-semibold mb-4 uppercase">Contact Info</h3>
      ...
      <div className="border-t border-purple-800 py-4">
        <div className="container mx-auto px-4 text-center text-sm text-gray-300">
          <p>&copy; {new Date().getFullYear()} GGF - Global Glamour Fashion. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
